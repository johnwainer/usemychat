        ...
        <div className="bg-slate-800/50 backdrop-blur-xl rounded-2xl p-8 border border-purple-500/20 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start">
              <input type="checkbox" className="w-4 h-4 mt-1 rounded border-purple-500/20 bg-slate-900/50 text-purple-500 focus:ring-purple-500" required />
          ...
          <div className="mt-8 pt-6 border-t border-purple-500/20">
            <p className="text-center text-sm text-gray-400 mb-4">O regístrate con</p>
            <div className="grid grid-cols-2 gap-4">
              <button className="flex items-center justify-center space-x-2 bg-slate-900/50 border border-purple-500/20 rounded-lg py-3 text-white hover:bg-slate-900 transition-colors">
