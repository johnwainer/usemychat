      ...
      >
        ...
        <div className="bg-slate-800/50 backdrop-blur-xl rounded-2xl p-8 border border-purple-500/20 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input type="checkbox" className="w-4 h-4 rounded border-purple-500/20 bg-slate-900/50 text-purple-500 focus:ring-purple-500" />
          ...
          <div className="mt-8 pt-6 border-t border-purple-500/20">
            <p className="text-center text-sm text-gray-400 mb-4">O continúa con</p>
